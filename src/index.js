...
export default class CancelablePromise /* extends Promise */ {
    ...
    then (onResolved, onRejected, onCanceled) {
        return CancelablePromise.race([
            this[INTERNAL_PROMISE].then(
                fnWrapper.call(this, onResolved),
                fnWrapper.call(this, onRejected)
            ),
            onCanceled && this.canceled(onCanceled),
        ]);
    }
     ...
     */
        ...
        return new CancelablePromise(
            this[INTERNAL_PROMISE].catch(fnWrapper.call(this, onRejected))
        );
    }
    ...
    static try (fn) {
        return Promise.try ?
            new CancelablePromise(Promise.try(fn))
        :
            new CancelablePromise(Promise.resolve().then(fn));
    }
}
